...
(function () {/*
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var D = u(A, "perf", w()), F = u(D, "g", w()), da = u(D, "i", w());
    u(D, "r", []);
    w();
    w();
    ...
    var ea = /^(\/[a-zA-Z0-9_\-]+)+$/, O = [/\/amp\//, /\/amp$/, /^\/amp$/], fa = /^[a-zA-Z0-9\-_\.,!]+$/, ga = /^gapi\.loaded_[0-9]+$/, ha = /^[a-zA-Z0-9,._-]+$/, la = function (a, b, c, d) {
    ...
    var R = decodeURI("%73cript"), S = /^[-+_0-9\/A-Za-z]+={0,2}$/, T = function (a, b) {
        ...
        if (e["::"] && b.length) {
            ...
            for (var f = null; f = b.shift();) {
                var l = f.split("."), l = e[f] || e[l[1] && "ns:" + l[0] || ""] || d, k = a.length && a[a.length - 1] || null, v = k;
        ...
        var k = u(C(c), "r", []).sort(), H = u(C(c), "L", []).sort(), E = [].concat(k), W = function (a, b) {
            if (z)return 0;
            g.clearTimeout(y);
            H.push.apply(H,
                p);
        ...
        var p = T(a, H);
        if (p.length) {
            var p = T(a, k), r = u(A, "CP", []), t = r.length;
            r[t] = function (a) {
                if (!a)return 0;
                K("ml1", p, E);
                var b = function (b) {
...
gapi.load("client", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.zh_CN.BSpK1w-Km44.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCPOrf3o7HB0v9CBhLKGfzAluuID1w",
            "u": "https://apis.google.com/js/client.js?onload\u003dcheckAuth",
            "hee": true,
            "fp": "433379190f19996702b5ad56564bb02fb7cc57d3",
            "dpo": false
        },
        "fp": "433379190f19996702b5ad56564bb02fb7cc57d3",
